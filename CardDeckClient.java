...
public class CardDeckClient {
        public static void main(String[] args) {
            Set<card> cpu = new HashSet<card>();// set is an array with no set length to keep adding
            Set<card> player1 = new HashSet<card>();

            startCards(player1);
            startCards(cpu);//deal your first hand
            
            Scanner input = new Scanner(System.in);//yes or no for calling from the user
